 ...
 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
     <div class="app-brand demo">
         ...
         @if (auth()->user()->hasAnyPermission([
             ...
             <li class="menu-item 
             {{ request()->is(['dashboard/finance/*', 'salesreturn/*', 'podreturn/*']) ? 'open' : '' }}">
             ...
             <ul class="menu-sub">
                 ...
                 @if(auth()->user()->hasAnyPermission([
                    ...
                    <li class="menu-item {{ request()->is(['dashboard/finance/*']) ? "open" : "" }}">
                     <a href="javascript:void(0);" class="menu-link menu-toggle">
                         <div>Finance</div>
                     </a>
                     ...
                     <ul class="menu-sub">
                         ...
                         <li class="menu-item {{ request()->is(['dashboard/finance/pbt']) ? 'active' : '' }}">
                     ...
                     <ul class="menu-sub">
                         @can('dashboard.finance.pbt.index')
                         <li class="menu-item {{ request()->is(['dashboard/finance/cit']) ? 'active' : '' }}">
                             <a href="{{ route('dashboard.cit.index') }}" class="menu-link">
                                <div>CIT</div>
                             </a>
                         </li>
                         @endcan
                     ...
                     <ul class="menu-sub">
                         ...
                         <li class="menu-item {{ request()->is(['dashboard/finance/sales-return/*']) ? 'active' : '' }}">
             ...
             @if (auth()->user()->hasAnyPermission([
                 ...
                 @if (auth()->user()->hasAnyPermission([
                     ...
                     @if (auth()->user()->hasAnyPermission([
                         ...
                         <li class="menu-item {{ request()->is(['calendar', 'calendar/*']) ? 'open' : '' }}">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                             <i class="menu-icon tf-icons ti ti-ticket"></i>
